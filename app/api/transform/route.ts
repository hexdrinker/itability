...
- 인종차별적 표현
- 성별·LGBTQ+ 혐오 표현
- 특정 실존 인물의 실명 (예: 히틀러, 박근혜, 윤석열, 이재명)
- 특정 실존 인물의 별명·은어가 욕설·비하·혐오 표현과 함께 사용된 경우 (예: "윤어게인 ㅅㅂ", "이죄명 꺼져")
  - 단, 별명·은어만 단독으로 사용된 경우는 허용 (예: 윤어게인, 이죄명, 재매이햄, 가카 → 변환 허용)
...
- References to real-world individuals, historical figures, or politicians by their real name (e.g., Hitler, Trump, Obama)
- Nicknames or slang for real-world individuals combined with profanity, slurs, or hateful language (e.g., "Drumpf sucks", "Sleepy Joe go die")
  - However, nicknames or slang alone WITHOUT profanity are allowed and should be transformed normally
