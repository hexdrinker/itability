      ...
      <div className='mt-6 w-full max-w-2xl flex flex-col items-center gap-4'>
        ...
        <div className='flex gap-3'>
          <button
            ...
            className='bg-amber-500 hover:bg-amber-400 disabled:bg-zinc-700 disabled:text-zinc-500 text-black font-bold text-base px-8 py-3 rounded-xl transition-colors'
          >
          ...
          {result && input === lastTransformedInput && (
            <button
              ...
              className='border border-zinc-700 hover:border-amber-500/50 hover:text-amber-400 text-zinc-400 font-medium text-base px-5 py-3 rounded-xl transition-colors'
            >
              캡쳐하기
            </button>
          )}
